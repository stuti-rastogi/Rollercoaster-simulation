...
{
public:
  int Init(const char * shaderBasePath, const char * vertexShaderFile, const char * fragmentShaderFile); // init the program, "shaderBasePath" is the path to the folder containing the shaders
